...
#define DISABLE_COPY_CONSTRUCTOR(type_name) \
	type_name(const type_name&) noexcept = delete;

#define DISABLE_COPY_ASSIGNMENT(type_name) \
	type_name& operator=(const type_name&) noexcept = delete;
...
#define ENABLE_COPY_CONSTRUCTOR(type_name) \
	type_name(const type_name& other) noexcept;

#define ENABLE_COPY_ASSIGNMENT(type_name) \
	type_name& operator=(const type_name& other) noexcept;

#define ENABLE_MOVE_CONSTRUCTOR(type_name) \
	type_name(type_name&& other) noexcept;

#define ENABLE_MOVE_ASSIGNMENT(type_name) \
	type_name& operator=(type_name&& other) noexcept;

#define ENABLE_COPY(type_name) \
	ENABLE_COPY_CONSTRUCTOR(type_name) \
	ENABLE_COPY_ASSIGNMENT(type_name)

#define ENABLE_MOVE(type_name) \
	ENABLE_MOVE_CONSTRUCTOR(type_name) \
	ENABLE_MOVE_ASSIGNMENT(type_name)
