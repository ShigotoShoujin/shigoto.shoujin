...
//
//#include "../../src/grid/row_iterator.hpp"
//#include <array>
//#include <vector>
//
...
//		Assert::IsTrue(std::is_copy_constructible_v<RowIterator<int>>);
//	}
//
//	TEST_METHOD(IsCopyAssignable) {
//		Assert::IsTrue(std::is_copy_assignable_v<RowIterator<int>>);
//	}
//
//	TEST_METHOD(IsMoveConstructible) {
//		Assert::IsTrue(std::is_move_constructible_v<RowIterator<int>>);
//	}
//
//	TEST_METHOD(IsMoveAssignable) {
//		Assert::IsTrue(std::is_move_assignable_v<RowIterator<int>>);
//	}
//
...
//		RowIterator<int> ii{arr.data(), arr.data() + arr.size(), width};
